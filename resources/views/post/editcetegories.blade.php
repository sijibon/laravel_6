  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <form action="{{ url ('update/cetegory/'.$cetegories->id)}}" method="post">
          @csrf
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Cetegory Name</label>
              <input type="text" class="form-control" value="{{ $cetegories->name}}" name="name">
            </div>
          </div>
          <br>
          <div class="form-group floating-label-form-group controls">
              <label>Slug Name</label>
              <input type="text" class="form-control" value="{{ $cetegories->slug }}" name="slug">
            </div>
          <br>
          <br>
